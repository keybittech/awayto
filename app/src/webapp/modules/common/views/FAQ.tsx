      ...
      <CardContent>
        <Grid container>
          ...
          <Grid item xs={12}>
            ...
            <Typography variant="body1"><strong>API:</strong> <pre>src/api</pre></Typography>
            ...
            <Typography variant="body1"><strong>Core:</strong> <pre>src/core</pre></Typography>
            ...
            <Typography variant="body1"><strong>Webapp:</strong> <pre>src/webapp</pre></Typography>
            ...
            <Typography variant="caption"><Grid className="overflow"><pre>{`// src/core/types/common.ts
...
`}</pre></Grid></Typography>
            ...
            <Typography variant="body1">Any new <pre>.sql</pre> files in the <pre>src/api/scripts</pre> folder can be deployed by running <pre>npm run db-update</pre> from the main directory.</Typography>
