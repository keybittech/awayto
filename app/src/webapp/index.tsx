...
import { history, components, addReducer, store, persistor, asyncForEach, IReducers, LazyComponentPromise } from 'awayto';
 ...
 */
async function awayto(renderComponent: JSX.Element): Promise<void> {
